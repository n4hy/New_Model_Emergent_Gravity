#!/usr/bin/env python3
"""Bulk first-law audit. No solver import.

1d N=160 L=20, |x_mid|<=L/4. 3d N=10 R=3, r_mid<=1.5. ε=0.015.

Writes ../data/m9_17_audit_bulk.json
"""
...
def main() -> int:
    ...
    payload = {
        "task": "m9.17_audit_bulk",
        "method": "bulk only; 1d N=160 L=20; 3d N=10 R=3 r_mid<=1.5",
        "one_d": d1,
        "three_d": d3,
        "verdicts": {"C3_bulk": "CONFIRMED" if ok else "REFUTED"},
    }
    os.makedirs(DATA, exist_ok=True)
    path = os.path.join(DATA, "m9_17_audit_bulk.json")
