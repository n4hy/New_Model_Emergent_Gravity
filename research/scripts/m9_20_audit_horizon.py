#!/usr/bin/env python3
"""Horizon-shape audit. No solver import.

1d N=160 L=20 ends. 3d N=14 R=3 surface, ε=0.015, stable n_occ.
CHM vs linear vs flat.

Writes ../data/m9_20_audit_horizon.json
"""
...
def main() -> int:
    ...
    payload = {
        "task": "m9.20_audit_horizon",
        "method": "1d N=160 L=20; 3d N=14 R=3 surface; stable n_occ",
        "one_d": d1,
        "three_d": d3,
        "verdicts": {"C4": "CONFIRMED" if ok else "REFUTED"},
    }
    os.makedirs(DATA, exist_ok=True)
    path = os.path.join(DATA, "m9_20_audit_horizon.json")
