#!/usr/bin/env python3
"""Larger-horizon audit. No solver import.

1d N=160 L=20 ends. 3d N=16 R=5, 5 lex bonds per same r_mid bins,
ε=0.015, stable n_occ.

Writes ../data/m9_21_audit_horizon.json
"""
...
def main() -> int:
    ...
    payload = {
        "task": "m9.21_audit_horizon",
        "method": "N=16 R=5, 5/bin; no solver import",
        "one_d": d1,
        "three_d": d3,
        "verdicts": {"C4": "CONFIRMED" if ok else "REFUTED"},
    }
    os.makedirs(DATA, exist_ok=True)
    path = os.path.join(DATA, "m9_21_audit_horizon.json")
